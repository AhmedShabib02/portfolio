        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">ahmed-shabib@Dell</div>
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-ahmed, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-ahmed":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-ahmed");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-ahmed, todoist, trash, settings, sendmsg ]";
                }
                break;
