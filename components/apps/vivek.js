...
export class AboutAhmed extends Component {
  constructor() {
    super();
    this.screens = {};
    this.state = {
    ...
    return (
      <>
        ...
        <div className="my-0.5 w-28 md:w-full h-8 px-2 md:px-2.5 flex">
          <iframe
            src="https://github.com/sponsors/ahmedshabib/button"
            title="Sponsor ahmedshabib"
            width={"100%"}
            height={"100%"}
          ></iframe>
        </div>
...
export const displayAboutAhmed = () => {
  return <AboutAhmed />;
};
    ...
    <>
      <div className="w-20 md:w-28 my-4 bg-white rounded-full">
        <img
          ...
          alt="Ahmed Shabib Logo"
        />
      </div>
      <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
        <div>
          my name is <span className="font-bold">Ahmed Shabib</span> ,
        </div>
      ...
      <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
        <li className="list-disc">
          <div className=" text-lg md:text-xl text-left font-bold leading-tight">
            NUCES - FAST NATIONAL UNIVERSITY
          </div>
...
function Projects() {
  const project_list = [
    {
      ...
      date: "Apr 2021",
      link: "https://github.com/ahmedshabib/ahmedshabib.github.io",
      description: [
    ...
    },
    {
      ...
      date: "Dec 2021",
      link: "https://github.com/ahmedshabib/chrome-extension-react-boilerplate",
      description: [
    ...
    },
    {
      name: "CodeConnect",
      date: "Nov 2021",
      link: "https://github.com/ahmedshabib/CodeConnect-frontend",
      description: [
    ...
    },
    {
      ...
      date: "Jun 2021",
      link: "https://github.com/ahmedshabib/ad-free-spotify",
      description: [
    ...
    },
    {
      ...
      date: "Jan 2021",
      link: "https://github.com/ahmedshabib/flutter-banking-app",
      description: [
    ...
    },
    {
      ...
      date: "Dec 2020",
      link: "https://github.com/ahmedshabib/CPU-Scheduling-APP-React-Native",
      description: [
    ...
    },
    {
      ...
      date: "Nov 2020",
      link: "https://github.com/ahmedshabib/Meditech-Healthcare",
      description: [
    ...
    },
    {
      ...
      date: "Sep 2020",
      link: "https://github.com/ahmedshabib/Improve-Codeforces",
      description: [
  ...
  return (
    <>
      ...
      <iframe
        src="https://github.com/sponsors/ahmedshabib/card"
        title="Sponsor ahmedshabib"
            ...
            <div className="w-full py-1 px-2 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5 cursor-pointer">
              <div className="flex flex-wrap justify-between items-center">
                <div className="flex justify-center items-center">
                  ...
                  <iframe
                    src={`https://ghbtns.com/github-btn.html?user=ahmedshabib&repo=${projectName}&type=star&count=true`}
                    frameBorder="0"
                    scrolling="0"
                    width="150"
                    height="20"
...
function Resume() {
  return (
    <iframe
      ...
      src="./files/Ahmed_Shabib.pdf"
      title="ahmed shabib resume"
      frameBorder="0"
    ></iframe>
  );
}
